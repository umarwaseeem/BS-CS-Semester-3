...
.data
    ...
    onto db "Onto Level 3, Get ready for the boss",0
...
main proc
    ...
    .while ah != 1      ;; until escape is entered
        ...
        ; ; ;; ~ alien3a, make and kill

        .IF alien3aKilled != 1 
            alien3 alien3aX, alien3aY, black
            add alien3aY, 2
            alien3 alien3aX, alien3aY, blue

            .IF alien3aY >= 280      ;; upper y limit of ship

                clear
                setVideoMode
                
                ; printGraphicString finished 15, 30, 1, 6          ;; gameover message displayed when alien reaches ship
            
                jmp exit
            .ENDIF
        .ELSEIF alien3aKilled == 1
            alien3 alien3aX, alien3aY, black
                clear
                setVideoMode
                gameBoundary
                printGraphicString onto, 15, 30, 1, 2
                call delay
                call delay
                jmp exit
        ...
        ; ; ; ~ alien3b, make and kill

        ; .IF alien3bKilled != 1 
        ;     alien3 alien3bX, alien3bY, black
        ;     add alien3bY, 2
        ;     alien3 alien3bX, alien3bY, blue

        ;     .IF alien3bY >= 280      ;; upper y limit of ship
        ...
        .IF (ah == 57)    ;; space key - fire
            ...
            .while fireY != 10 
                ...
                mov dx, alien3aX        
                add dx, 120             ;; right range of alien x-axis and alien3ax is left range of its x-axis

                .IF (  (si >= alien3aX && si <= dx) && (di <= alien3aY)  )  ;; -killed alien3a
                    mov alien3aKilled, 1
                    jmp outOfLoop
                .ENDIF
                ...
                ; .IF (  (si >= alien3bX && si <= dx) && (di <= alien3bY)  )  ;; -killed alien3b
                ;     mov alien3bKilled, 1
                ;     jmp outOfLoop
                ; .ENDIF
